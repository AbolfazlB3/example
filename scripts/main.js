...
const physics = new Physics(n, iterations, 1);
...
var mouse = [null, null], lmouse = mouse, moused = false
...
function setMouse(e) {
  const scale = vp.scl
  mouse = [e.offsetX * canvasScale / scale, e.offsetY * canvasScale / scale]
}
